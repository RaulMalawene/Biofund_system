    ...
    <transition name="fade">
      <div class="submit-overlay" v-if="loading">
        <div class="submit-loader">
          <svg class="spin-lg" width="44" height="44" fill="none" stroke="#2D6A4F" stroke-width="2.5" viewBox="0 0 44 44">
        ...
        <div class="drawer-body">
          ...
          <div class="success-banner" v-if="submitted">
            ...
            <div>
              ...
              <span class="tracking-inline" v-if="lastTrackingCode">Código: <strong>{{ lastTrackingCode }}</strong></span>
            </div>
          </div>
