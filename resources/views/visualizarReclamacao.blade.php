...
<head>
  ...
  <title>BioQueixa – Consultar Reclamação</title>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    body { font-family: 'Poppins', sans-serif; color: var(--text-dark); background: var(--offwhite); }
    ...
    .nav-links a { text-decoration: none; color: var(--text-gray); font-size: 13.5px; font-weight: 500; transition: color .2s; }
    .nav-links a:hover { color: var(--green-mid); }
    .nav-links a.active { color: var(--green-mid); font-weight: 600; }
    .btn-restricted {
      background: var(--white); color: var(--text-dark);
      border: 1.5px solid var(--border); border-radius: 7px;
      padding: 7px 18px; font-family: 'Poppins', sans-serif;
      font-size: 13px; font-weight: 600; cursor: pointer; transition: border-color .2s;
    }
    .btn-restricted:hover { border-color: var(--green-mid); }
    ...
    .search-hero p  { font-size: 14px; color: var(--text-gray); line-height: 1.65; margin-bottom: 32px; }
    ...
    .btn-consultar {
      ...
      padding: 0 28px; font-family: 'Poppins', sans-serif;
    ...
    .badge-cat {
      display: inline-block; background: #FFF3E0; color: #C66E00;
    ...
    /* sections */
    .detail-section { margin-bottom: 24px; padding-bottom: 24px; border-bottom: 1px solid var(--border); }
    ...
    .section-label svg { color: var(--text-gray); }
    ...
    .attach-thumb {
      width: 155px; border: 1px solid var(--border); border-radius: 10px;
      overflow: hidden; position: relative; cursor: pointer;
      transition: box-shadow .2s;
    }
    .attach-thumb:hover { box-shadow: 0 4px 16px rgba(0,0,0,.12); }
    ...
    .btn-dl {
      background: none; border: none; cursor: pointer; color: var(--green-mid);
      display: flex; transition: color .2s;
    }
    .btn-dl:hover { color: var(--green-dark); }
    .attach-end {
      width: 155px; height: 100px; display: flex;
      align-items: center; justify-content: center;
      font-size: 12px; color: var(--text-light);
      background: #F7F9F8; border: 1px dashed var(--border); border-radius: 10px;
    }
    ...
    .status-label { font-size: 11px; font-weight: 700; letter-spacing: 1px; text-transform: uppercase; color: var(--text-gray); }
    ...
    .tl-connector {
      width: 2px; background: #E4EDE6; flex: 1; margin: 4px 0;
      min-height: 28px;
    }
    ...
    .tl-more {
      ...
      color: var(--green-mid); font-family: 'Poppins', sans-serif;
    ...
    .help-header svg { color: var(--green-mid); }
    ...
    .footer-brand p { font-size: 12.5px; color: var(--text-gray); line-height: 1.65; max-width: 220px; margin-top: 12px; }
    .footer-col h5 { font-size: 13px; font-weight: 700; margin-bottom: 14px; }
    .footer-col a {
      display: flex; align-items: center; gap: 6px;
      font-size: 12.5px; color: var(--text-gray); text-decoration: none;
    ...
    .social-link {
      ...
      text-decoration: none; color: var(--text-gray); transition: border-color .2s, color .2s;
    }
...
<div id="app">
  ...
  <nav>
    ...
    <div class="nav-links">
      ...
      <a href="/visualizarReclamacao" class="active">Consultar</a>
    </div>
  ...
  <section class="search-hero">
    ...
    <p>Insira o código único recebido no momento da submissão para verificar o<br/>estado atual e as atualizações da nossa equipe.</p>
  ...
  <footer>
    <div class="footer-grid">
      ...
      <div class="footer-col">
        ...
        <a href="#">Reportar Incidente</a>
        <a href="#">Acompanhar Caso</a>
      </div>
      <div class="footer-col">
        <h5>Institucional</h5>
        <a href="#"><svg width="13" height="13" fill="none" viewBox="0 0 14 14"><rect x="1" y="3" width="12" height="9" rx="1.5" stroke="currentColor" stroke-width="1.3"/><path d="M1 5L7 9l6-4" stroke="currentColor" stroke-width="1.3"/></svg>Biofund Moçambique</a>
        <a href="#"><svg width="13" height="13" fill="none" viewBox="0 0 14 14"><rect x="1" y="3" width="12" height="9" rx="1.5" stroke="currentColor" stroke-width="1.3"/><path d="M1 5L7 9l6-4" stroke="currentColor" stroke-width="1.3"/></svg>Políticas de Privacidade</a>
        <a href="#"><svg width="13" height="13" fill="none" viewBox="0 0 14 14"><rect x="1" y="3" width="12" height="9" rx="1.5" stroke="currentColor" stroke-width="1.3"/><path d="M1 5L7 9l6-4" stroke="currentColor" stroke-width="1.3"/></svg>Contacto Direto</a>
      </div>
      <div class="footer-col">
        <h5>Siga-nos</h5>
        <div class="social-links">
          <a href="#" class="social-link"><svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg></a>
          <a href="#" class="social-link"><svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"/></svg></a>
          <a href="#" class="social-link"><svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg></a>
        </div>
      </div>
    </div>
    <div class="footer-bottom">© 2026 BioQueixa. Todos os direitos reservados. Inspirado na conservação ambiental de Moçambique.</div>
  </footer>
...
const mockDB = {
  'BQ-2024-0852': {
    ...
    historico: [
      {
        titulo: 'Equipe Deslocada',
        data:   '15 Out, 2024 · 10:20',
        descricao: 'Inspetores ambientais foram enviados para a zona de Marracuene.'
      },
      {
        titulo: 'Em Análise Preliminar',
        data:   '13 Out, 2024 · 14:45',
        descricao: 'Reclamação aceite e triagem realizada pelo departamento de fiscalização.'
      },
      {
        titulo: 'Submetido',
        data:   '12 Out, 2024 · 16:30',
        descricao: 'A sua reclamação foi registada com sucesso no sistema BioQueixa.'
      }
    ],
    anexos: [
    ...
    historico: [
      {
        ...
        data:   '20 Set, 2024 · 09:00',
        descricao: 'Suspeitos identificados e armadilhas removidas. Processo entregue ao Ministério Público.'
      },
      {
        titulo: 'Operação Realizada',
        data:   '10 Set, 2024 · 07:30',
        descricao: 'Patrulha especial deslocada à zona. Armadilhas documentadas e confiscadas.'
      },
      {
        titulo: 'Submetido',
        data:   '3 Set, 2024 · 19:15',
        descricao: 'Reclamação registada com sucesso no sistema BioQueixa.'
      }
    ],
    anexos: [
...
createApp({
  setup() {
    ...
    return { searchCode, result, notFound, consultar, loadDemo };
  }
}).mount('#app');
</script>
</body>
